...
function createInstance(
  ...
  return new ec2.Instance(scope, "HytaleInstance", {
    ...
    securityGroup: sg,
    role,
    instanceType: ec2.InstanceType.of(ec2.InstanceClass.T3A, ec2.InstanceSize.MEDIUM), // 2 vCPU / 4 GiB
...
function addHytaleUserData(instance: ec2.Instance, downloaderZipAsset: s3assets.Asset) {
  // ----------------------------
